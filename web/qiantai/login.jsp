...
<script>
	function refresh() {
		var rd=Math.random();
		document.getElementById("code").src="${pageContext.request.contextPath}/qt/QtUserServlet?bs=validate&rd="+rd;
	}
</script>
<body>
<!--LOGO欢迎信息和登陆注册功能-->
<div class="block clearfix">
	<div class="f_l">
		<a href="${pageContext.request.contextPath}/qt/QtGoodServlet?bs=open&type=纵火类" name="top"><img src="${pageContext.request.contextPath}/qiantai/images/logo.gif"/></a>
	</div>
 	<div class="f_r log">
		<ul>
	    	<li class="userInfo">
...
<div class="usBox clearfix">
	<div class="usBox_1 f_l">
		...
		<form name="formLogin" action="${pageContext.request.contextPath}/qt/QtUserServlet" method="post">
			<input type="hidden" name="bs" value="login">
			<table width="100%" border="0" align="left" cellpadding="3" cellspacing="5">
				...
				<tr>
					...
					<td><input name="validate" type="text" size="3" />
					<img src="${pageContext.request.contextPath}/qt/QtUserServlet?bs=validate" width="90px" height="20px" id="code"/>
