...
<div class="block clearfix">
	<div class="f_l">
		<a href="${pageContext.request.contextPath}/qiantai/index.jsp" name="top"><img src="${pageContext.request.contextPath}/qiantai/images/logo.gif"/></a>
	</div>
 	<div class="f_r log">
		<ul>
	    	<li class="userInfo">
...
<div id="mainNav" class="clearfix">
	<a href="${pageContext.request.contextPath}/qt/QtGoodServlet?bs=open&type=吸烟类" class="cur">首页<span></span></a>
...
<div class="block clearfix">
	...
	<div class="AreaL">
		...
		<div class="cart" id="ECS_CARTINFO">
 			<a href="${pageContext.request.contextPath}/qiantai/flow.jsp" title="查看购物车">您的购物车中有<%=request.getSession().getAttribute("totalAmount")%>件商品，总计金额<%=request.getSession().getAttribute("totalAccount")%> 元。</a>
		</div>
		<div class="blank5"></div>
		<!--左侧分类栏-->
		<div class="box">
 			<div class="box_1">
  				<div id="category_tree">
					<c:forEach items="${types}" var="type">
         			<dl>
     					<dt>
							<a href="${pageContext.request.contextPath}/qt/QtGoodServlet?bs=open&type=${type}">${type}</a>
						</dt>
	       			</dl>
					</c:forEach>
  				</div>
					...
					<c:forEach items="${goods}" var="good">
      				<div class="goodsItem">
         				<span class="best"></span>
           				<a href="${pageContext.request.contextPath}/qt/QtGoodServlet?bs=addGood&id=${good.id}">
							<img src="${pageContext.request.contextPath}/qt/QtGoodServlet?bs=getImg&pic=${good.pic}" alt="测试商品1" class="goodsimg" /></a>
